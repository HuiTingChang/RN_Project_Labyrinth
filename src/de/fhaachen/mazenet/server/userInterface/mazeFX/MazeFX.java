...
public class MazeFX extends Application implements UI {
    ...
    //private static final Translate3D SHIFT_CARD_TRANSLATE = new Translate3D(0,-0.2,-(BOARD_HEIGHT/2.+1));
    ...
    public void start(Stage primaryStage) throws IOException {
        ...
        primaryStage.setTitle("MazeFX (aka BetterBetterUI)");
    ...
    private void animateMove(MoveMessageType mm, Board b, long mvD, long shifD, boolean treasureReached){
        ...
        //SequentialTransition completeShiftAnim = new SequentialTransition(animBefore,animShift,animAfter);
        ...
        Translate3D newPinTr = getCardTranslateForPosition(newPinPos.getCol(),newPinPos.getRow()).translate(newPinOffset);
